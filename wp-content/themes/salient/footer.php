			...
			<div class="container">
				...
				<div class="col span_5">
					...
					<?php if(!empty($options['disable-auto-copyright']) && $options['disable-auto-copyright'] == 1) { ?>
						<p><?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> <a href="http://www.mafiashare.net">WP themes</a></p>	
					<?php } else { ?>
						<p>&copy; <?php echo date('Y') . ' ' . get_bloginfo('name'); ?>. <?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> <a href="http://www.mafiashare.net">Wordpress</a></p>
					<?php } ?>
